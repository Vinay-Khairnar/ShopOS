...
export default async function KhataPage() {
  ...
  const t = await getTranslations("Khata");
    ...
    <div className="px-4">
      <div className="mb-6 flex justify-between items-end">
        ...
        <div className="text-right">
          <p className="text-xs font-semibold text-neutral-500 uppercase">{t('totalOwed')}</p>
      ...
      {error ? (
        ...
        <div className="flex flex-col items-center justify-center p-12 text-center bg-white rounded-3xl border border-neutral-100 shadow-sm mt-8">
          ...
          <h3 className="text-lg font-bold text-neutral-900">{t('allClear')}</h3>
